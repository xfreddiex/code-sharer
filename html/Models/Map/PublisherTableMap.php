...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Models\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Publisher) { // it's a model object
