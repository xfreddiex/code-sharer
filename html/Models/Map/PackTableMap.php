  ...
  array (
    ...
    public function getBehaviors()
    {
        return array(
            ...
            'validate' => array('rule1' => array ('column' => 'name','validator' => 'Length','options' => array ('max' => 32,'maxMessage' => 'Maximal pack name length is {{ limit }} characters.',),), 'rule2' => array ('column' => 'name','validator' => 'Regex','options' => array ('pattern' => '/^[^\\s]*$/','match' => true,'message' => 'Pack name should not contain whitespaces.',),), 'rule3' => array ('column' => 'name','validator' => 'NotBlank','options' => array ('message' => 'Pack name should not be blank.',),), 'rule4' => array ('column' => array ('name,' => 'user_id',),'validator' => 'Uniqueness','options' => array ('message' => 'You already have pack with this name.',),), 'rule5' => array ('column' => 'description','validator' => 'Length','options' => array ('max' => 256,'maxMessage' => 'Maximal pack description length is {{ limit }} characters.',),), ),
        );
    } // getBehaviors()
