...
class PackTableMap extends TableMap
{
     ...
     */
    const COL_CHANGED_AT = 'pack.changed_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Description', 'Public', 'CreatedAt', 'ChangedAt', 'DeletedAt', 'Tags', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'description', 'public', 'createdAt', 'changedAt', 'deletedAt', 'tags', ),
        self::TYPE_COLNAME       => array(PackTableMap::COL_ID, PackTableMap::COL_NAME, PackTableMap::COL_DESCRIPTION, PackTableMap::COL_PUBLIC, PackTableMap::COL_CREATED_AT, PackTableMap::COL_CHANGED_AT, PackTableMap::COL_DELETED_AT, PackTableMap::COL_TAGS, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'description', 'public', 'created_at', 'changed_at', 'deleted_at', 'tags', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Description' => 2, 'Public' => 3, 'CreatedAt' => 4, 'ChangedAt' => 5, 'DeletedAt' => 6, 'Tags' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'public' => 3, 'createdAt' => 4, 'changedAt' => 5, 'deletedAt' => 6, 'tags' => 7, ),
        self::TYPE_COLNAME       => array(PackTableMap::COL_ID => 0, PackTableMap::COL_NAME => 1, PackTableMap::COL_DESCRIPTION => 2, PackTableMap::COL_PUBLIC => 3, PackTableMap::COL_CREATED_AT => 4, PackTableMap::COL_CHANGED_AT => 5, PackTableMap::COL_DELETED_AT => 6, PackTableMap::COL_TAGS => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'public' => 3, 'created_at' => 4, 'changed_at' => 5, 'deleted_at' => 6, 'tags' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PackTableMap::COL_CHANGED_AT);
