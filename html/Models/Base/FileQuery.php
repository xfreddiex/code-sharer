 ...
 *
 * @method     \Models\PackQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class FileQuery extends ModelCriteria
{
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FileTableMap::COL_CODE, $code, $comparison);
    }
